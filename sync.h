...
/*!
    ...
    В этом файле объявлены все функции, необходимые для выполнения программой её основной задачи - синхронизации действий пользователя и переключения режимов работы программы
*/
